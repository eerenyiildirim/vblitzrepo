        ...
        def fiyat_takip_et(coin, fiyat, closes):
            if coin in aktif_islemler:
                ...
                # 🔁 Yaklaşık her 30 dakikada bir güncelleme mesajı
        ...
        def gundelik_rapor_gonder():
            try:
                ...
                if df_gunluk.empty:
                    print("📭 Bugün hiç işlem kaydı yok.")
                    return
                ...
                basari = ((tp1 + tp2) / toplam) * 100 if toplam > 0 else 0
                ...
                mesaj = (
                    ...
                    f"🏁 TP2: {tp2}\n"
                    f"❌ SL: {sl}\n\n"
                    f"📈 Başarı oranı: %{basari:.1f}\n"
                    f"⏱ Ortalama TP süresi: {ort_sure} saat\n"
                )
        ...
        def haftalik_rapor_gonder():
            try:
                ...
                if df_haftalik.empty:
                    print("📭 Bu hafta işlem kaydı yok.")
                    return
                ...
                print("Haftalık rapor oluşturulamadı:", e)
